    ...
    <AppLayout>
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <Section title="Калькулятор стоимости" icon={Calculator}>
          <p>Главная страница приложения — <strong>калькулятор расчёта стоимости изделий</strong>.</p>
          <Step n={1}>
        ...
        <Section title="Сохранение расчёта" icon={Save}>
          <Step n={1}>
            После расчёта нажмите кнопку <strong>«Сохранить»</strong> (иконка дискеты).
          </Step>
          <Step n={2}>
            Введите <strong>название расчёта</strong> — например, имя клиента или адрес объекта. Это поможет быстро найти расчёт позже.
          </Step>
          <Step n={3}>
            Расчёт сохранится в вашей <strong>истории</strong>.
          </Step>
        </Section>
        ...
        <Section title="Калькулятор ящика" icon={Package}>
          <p>
            Отдельный инструмент для расчёта размеров упаковочного ящика. Перейдите на страницу <strong>«Ящик»</strong> в навигации, введите параметры изделия — система подскажет оптимальные размеры ящика.
          </p>
        </Section>

        <Section title="Тёмная / Светлая тема" icon={Sun}>
          <p>
            Нажмите на иконку <strong>солнца/луны</strong> в верхнем меню для переключения между тёмной и светлой темами. Настройка сохраняется автоматически.
          </p>
        </Section>
