        ...
        {isAdmin && (
          <>
            ...
            <Section title="Панель администратора — обзор" icon={Settings}>
              <p>
                Перейдите в раздел <strong>«Администрирование»</strong> в боковом меню (видно только администраторам). Панель содержит разделы:
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li><strong>Продукты и цены</strong> — прайсы, палитра цветов, иконки продуктов</li>
                <li><strong>Люди и доступ</strong> — пользователи, расчёты, группы прав доступа</li>
                <li><strong>Справочники</strong> — контрагенты, номенклатура</li>
                <li><strong>Настройки и доки</strong> — контактная информация, шаблон печати</li>
              </ul>
            </Section>
            ...
            <Section title="Важные примечания" icon={Settings}>
              <ul className="list-disc pl-5 space-y-1">
                <li><strong>Лиды</strong> — при сохранении расчёта автоматически создаётся лид в разделе «Продажи». Дальнейшая работа с клиентом ведётся через лид.</li>
                ...
                <li><strong>Данные специалиста</strong> — в документе указываются ФИО, телефон, email и Telegram того сотрудника, который выполнил расчёт.</li>
                <li><strong>Изменение цен</strong> — влияет только на новые расчёты. Старые расчёты сохраняют свои значения.</li>
                <li><strong>Навигация</strong> — используйте боковое меню для переключения между разделами: Главная, Калькуляторы, Продажи, Производство, Склад.</li>
              </ul>
            </Section>
          </>
        )}
