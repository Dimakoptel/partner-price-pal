...
import {
  calculateBox, MaterialSettings, defaultMaterials, loadMaterials, saveMaterials,
  BoxCalculationResult, Sheet, Beam, BoxDimensions,
...
export default function BoxCalculatorInline() {
